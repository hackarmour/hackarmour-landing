	...
	return (
		<div>
			<Head>
				...
				<meta
					name="description"
					content="Privacy policy for HackArmour"
				/>
				...
				<Contents>
					<Content>
						...
						<Content_Description className="text-2">
							<p>
								At HackArmour, accessible from
								https://hackarmour.com, one of our main
							...
							<p>
								...
								they shared and/or collect in HackArmour. This
							...
							<p>
								...
								as name, company name, and email address.
							</p>
							<br />
							...
							<br />
							<p>
								HackArmour follows a standard procedure of using
							...
							<p>
								...
								HackArmour, which are sent directly to
							...
							<br />
							<p>
								Note that HackArmour has no access to or control
							...
							<br />
							<p>
								HackArmour&apos;s Privacy Policy does not apply
							...
							<p>
								HackArmour does not knowingly collect any
